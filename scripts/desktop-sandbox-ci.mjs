 ...
 * installs just this helper into a fresh root-owned directory on its disposable VM.
 */
...
if (process.argv[1] && resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  ...
  console.log('SANDBOX_HELPER_VERIFIED', stageSandbox(projectRoot, destination));
}
