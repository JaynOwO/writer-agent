...
try{
 ...
 writeFileSync(join(process.env.SIGLUM_TEST_OUTPUT||temp,'desktop-e2e.json'),JSON.stringify({runId:testOwner.id,passed,checks,versions:process.versions,fixture:'owned synthetic data; composition events, not actual OS IME; no remote services'},null,2));
